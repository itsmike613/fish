...
export class Renderer {
	...
	constructor({ state }) {
		...
		this.scene.fog = new THREE.FogExp2(0x87c7ff, 0.0006); // warm beach haze
	...
	update() {
		// Underwater look: cyan fog when camera dips below water surface
